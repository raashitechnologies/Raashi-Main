...
import {
  LayoutDashboard, FileText, Globe, BookOpen, Briefcase,
  ClipboardList, Mail, Users, BarChart3, LogOut,
  Menu, X, ChevronRight, ScrollText,
} from "lucide-react";
...
const sidebarSections = [
  ...
  },
  {
    label: "Applications",
    items: [
      { label: "Internship Applications", href: "/admin/internship-applications", icon: ClipboardList },
      { label: "Career Applications", href: "/admin/career-applications", icon: ClipboardList },
  ...
  },
  {
    label: "Management",
    items: [
      { label: "Application Policies", href: "/admin/policies", icon: ScrollText },
      ...
      <div className="flex-1 lg:ml-64 min-h-viewport flex flex-col">
        ...
        <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-200/60 h-14 flex items-center px-4 lg:px-6 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
          <button
            ...
            className="lg:hidden p-1.5 rounded-lg hover:bg-gray-100 text-gray-600 mr-3 transition-colors"
          >
            <Menu size={20} />
          </button>
          <div className="flex items-center gap-1.5 text-sm text-gray-500">
            <Link to="/admin/dashboard" className="hover:text-brand-blue transition-colors">Admin</Link>
