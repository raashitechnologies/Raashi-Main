...
export function PreFooterCTA({
  ...
  return (
    <section className="bg-brand-navy py-16 lg:py-20" aria-label="Call to action">
        ...
        <FadeInView>
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-start gap-4 text-center lg:text-left flex-col lg:flex-row lg:items-center">
              ...
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-1.5 leading-tight">
                  {headline}
                </h2>
                <p className="text-white/70 text-base">{subtext}</p>
              </div>
            </div>
