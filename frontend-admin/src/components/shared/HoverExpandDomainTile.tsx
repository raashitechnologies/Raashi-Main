  ...
  return (
    <motion.div
      ...
      style={{
        ...
        overflow: "hidden",
        position: "relative",
        // Fixed height ensures zero layout reflow when expanding/collapsing.
        minHeight: "380px",
        cursor: "pointer",
        display: "flex",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          height: 120,
          borderRadius: "50%",
          background: `radial-gradient(ellipse at 50% 0%, ${domain.accentColor}20 0%, transparent 70%)`,
          filter: "blur(32px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
        ...
        {isActive && (
          ...
          >
            <Link
              ...
              id={`domain-tile-cta-${domain.slug}`}
              className="bg-[#0560DF] hover:bg-[#0E2F9D] text-white transition-all duration-200"
              style={{
                display: "inline-flex",
                alignItems: "center",
                gap: 6,
